  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {/* Total Revenue */}
        <Card className="border-l-4 border-l-blue-600 bg-white shadow-md">
        ...
        {/* Total Orders */}
        <Card className="border-l-4 border-l-purple-600 bg-white shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Total Customers */}
        <Card className="border-l-4 border-l-green-600 bg-white shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Average Order Value */}
        <Card className="border-l-4 border-l-orange-600 bg-white shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="font-bold text-slate-900">{formatPrice(Number(order.totalAmount))}</p>
